...
figAll <- function(filename="fig/figall", part=1){
  ...
  plot0(c(0,10), c(0,.5))
  seqx <- seq(0, 10, .1)
  if (part==1) text(5,.25, labels="e.g. temperature", cex=3)
  if (part>3 & part<8) lines(seqx, dnorm(seqx, 2, .78), col=colg2, lwd=1.8)
  if (part>4 & part<8) {
    lines(seqx, dnorm(seqx, 5.4, .78), col=col1, lwd=1.8)
    lines(seqx, dnorm(seqx, 8.2, .78), col=col3, lwd=1.8)
  }
  if (part>5) lines(seqx, dnorm(seqx, 5, 1.1), col=col2, lwd=1.8)

  if (part>7){
    lines(seqx, dnorm(seqx, 6.4, 1), col=col1, lwd=1.8)
    lines(seqx, dnorm(seqx, 2, .88), col=colg2, lwd=1.8)
  }

  par(mar=c(0.1, 2, 0.1, 2))
  image(matrix(1:100, ncol=1), col=rev(mypal), axes=FALSE, ann=FALSE)
  ...
  myspec(2, 1, 1, .8, pch=19, cex=1.2, col=colg2, lwd=.8)
  if (part==1) circle(x = 1, y = 1, radi =.9, lwd=1)

  if (part>1){
    myspec(60, 1, 1, .8, pch=19, cex=1.2, col=colg2, lwd=.8)
    if (part>2){
      myspec(60, 2, 4, .8, pch=19, cex=1.2, col=colg2, lwd=.8)
      myspec(60, 3, 2, .8, pch=19, cex=1.2, col=colg2, lwd=.8)
    }
  }

  if (part>4 & part<8){
    myspec(60, 5, 3.8, 1.2, pch=19, cex=1.2, col=col1, lwd=.8)
    myspec(40, 4.5, 1, .6, pch=19, cex=1.2, col=col1, lwd=.8)
    myspec(45, 6.8, 1.6, 1, pch=19, cex=1.2, col=col1, lwd=.8)
    #
    myspec(60, 7.5, 4, .8, pch=19, cex=1.2, col=col3, lwd=.8)
    myspec(80, 9, 1.6, 1.4, pch=19, cex=1.2, col=col3, lwd=.8)
  }
  if (part>7){
    myspec(60, 5, 3.8, 1.2, pch=19, cex=1.2, col=col1, lwd=.8)
    myspec(20, 5, 3.8, 1.2, pch=19, cex=1.2, col=colg2, lwd=.8)
    myspec(30, 4.5, 1, .6, pch=19, cex=1.2, col=colg2, lwd=.8)
    myspec(45, 6.8, 1.6, 1, pch=19, cex=1.2, col=col1, lwd=.8)
    #
    myspec(60, 7.5, 4, .8, pch=19, cex=1.2, col=col1, lwd=.8)
    myspec(80, 9, 1.6, 1.4, pch=19, cex=1.2, col=col1, lwd=.8)
  }
  if (part>5){
    myspec(30, 5, 3.8, 1.2, pch=19, cex=1.2, col=col2, lwd=.8)
    myspec(20, 7.5, 4, .8, pch=19, cex=1.2, col=col2, lwd=.8)
    myspec(15, 3, 2, .8, pch=19, cex=1.2, col=col2, lwd=.8)
  }
  ...
  if (part>5){
    ...
    points(c(2,5,5),c(1.5,1.5,8.5), pch=19, col=c(colg2, col1, col2), cex=3.4)
    if (part<8) points(8, 1.5, pch=19, col=col3, cex=3.4)
  }
  ...
  if (part>6){
    ...
    lines(c(.1,xe), c(.1,.1), lwd=1.4)
    lines(c(.1,.4), c(.65,.65), lwd=1.4)
    lines(c(.4,xe), c(.5,.5), lwd=1.4)
    lines(c(.4,xe2), c(.9,.9), lwd=1.4)
    lines(c(.1,.1), c(.1,.65), lwd=1.4)
    lines(c(.4,.4), c(.5,.9), lwd=1.4)
    lines(c(0,.1), c(.375,.375), lwd=1.4)
    points(c(xe,xe,xe2), c(.1, .5, .9), col=c(colg2, col1, cold), pch=19, cex=2.2)
  }
